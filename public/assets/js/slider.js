...
const portfolioContents = {
  game: [
    {
      image: "assets/image/img-bg-popup/Mavia.png",
    ...
    {
      image: "assets/image/img-bg-popup/Undead_Block.png",
      title: "Undead Block",
    ...
    {
      image: "assets/image/img-bg-popup/Fortia.png",
      title: "Fortia",
      ...
      image: "assets/image/img-bg-popup/Warena.png",
      title: "Warena",
    ...
    {
      image: "assets/image/img-bg-popup/EpicWar.png",
      title: "Epic War",
  ...
  investment: [
    {
      image: "assets/image/img-bg-popup/memePad.png",
      title: "Memepad",
    ...
    {
      image: "assets/image/img-bg-popup/TX8.png",
      title: "TX8",
    ...
    {
      image: "assets/image/img-bg-popup/Treelion.png",
      title: "Treelion",
  ...
  finance: [
    {
      image: "assets/image/img-bg-popup/topaz.png",
      title: "TOPAZ",
    ...
    {
      image: "assets/image/img-bg-popup/atlas.png",
      title: "ATLAS",
  ...
  insurance: [
    {
      image: "assets/image/img-bg-popup/midas.png",
      title: "MIDAS",
    ...
    {
      image: "assets/image/img-bg-popup/sto.png",
      title: "STO",
  ...
  education: [
    {
      image: "assets/image/img-bg-popup/themis.png",
      title: "THEMIS",
    ...
    {
      image: "assets/image/img-bg-popup/JUCC.png",
      title: "JUCC",
  ...
  entertainment: [
    {
      image: "assets/image/img-bg-popup/nafter.png",
      title: "Nafter",
    ...
    {
      image: "assets/image/img-bg-popup/EventX.png",
      title: "EventX",
