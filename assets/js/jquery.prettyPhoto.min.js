    ...
    (w.fn.prettyPhoto = function (e) {
      ...
      function c() {
        w(".pp_loaderIcon").hide(),
          (projectedTop =
            scroll_pos.scrollTop + (d / 2 - i.containerHeight / 2)),
          projectedTop < 0 && (projectedTop = 0),
          $ppt.fadeTo(settings.animation_speed, 1),
          $pp_pic_holder
            .find(".pp_content")
            .animate(
              { height: i.contentHeight, width: i.contentWidth },
          ...
          $pp_pic_holder.animate(
            {
              top: projectedTop,
              left:
                h / 2 - i.containerWidth / 2 < 0
                  ? 0
                  : h / 2 - i.containerWidth / 2,
            ...
            function () {
              $pp_pic_holder
                ...
                isSet && "image" == f(pp_images[set_position])
                  ? $pp_pic_holder.find(".pp_hoverContainer").show()
                  : $pp_pic_holder.find(".pp_hoverContainer").hide(),
                settings.allow_expand &&
                  (i.resized
                    ? w("a.pp_expand,a.pp_contract").show()
                    : w("a.pp_expand").hide()),
                !settings.autoplay_slideshow ||
                  n ||
                  t ||
                  w.prettyPhoto.startSlideshow(),
          ...
          "image" == f(pp_images[set_position])
            ? ((itemWidth = 57),
              (navWidth =
              ...
              (itemsPerPage = Math.floor(
                (i.containerWidth - 100 - navWidth) / itemWidth
              )),
              (itemsPerPage =
      ...
      function g(t, e) {
        if (
          ...
          (imageWidth = t),
          (imageHeight = e),
          (h < s || d < a) && doresize && settings.allow_resize && !r)
        ) {
          for (resized = !0, fitting = !1; !fitting; )
            h < s
              ? ((imageWidth = h - 200), (imageHeight = (e / t) * imageWidth))
              : d < a
              ? ((imageHeight = d - 200), (imageWidth = (t / e) * imageHeight))
              : (fitting = !0),
              (a = imageHeight),
              (s = imageWidth);
      ...
      function y() {
        if (
          ...
          for (var t = 0; t < pp_images.length; t++)
            (img_src = pp_images[t].match(/\b(jpg|jpeg|png|gif)\b/gi)
              ? ((classname = ""), pp_images[t])
              : ((classname = "default"), "")),
              (toInject +=
                "<li class='" +
                classname +
          ...
          (toInject = settings.gallery_markup.replace(/{gallery}/g, toInject)),
            ...
            $pp_gallery.find(".pp_arrow_next").on("click", function () {
              return (
                w.prettyPhoto.changeGalleryPage("next"),
            ...
            $pp_gallery.find(".pp_arrow_previous").on("click", function () {
              return (
                w.prettyPhoto.changeGalleryPage("previous"),
                w.prettyPhoto.stopSlideshow(),
                !1
              );
            }),
        ...
        settings.slideshow &&
          ...
          w("a.pp_close").on("click", function () {
            return w.prettyPhoto.close(), !1;
          }),
          settings.allow_expand &&
            w("a.pp_expand").on("click", function (t) {
              return (
                (doresize = w(this).hasClass("pp_expand")
                  ? (w(this).removeClass("pp_expand").addClass("pp_contract"),
                    !1)
                  : (w(this).removeClass("pp_contract").addClass("pp_expand"),
                    !0)),
                _(function () {
                  w.prettyPhoto.open();
                }),
          ...
          $pp_pic_holder
            ...
            .on("click", function () {
              return (
                w.prettyPhoto.changePage("previous"),
                w.prettyPhoto.stopSlideshow(),
                !1
              );
            }),
      ...
      return (
          ...
          .on("resize.prettyphoto", function () {
            u(),
              ...
              "undefined" != typeof $pp_overlay &&
                $pp_overlay.height(w(document).height()).width(h);
          }),
        ...
        (w.prettyPhoto.initialize = function () {
          return (
            ...
            (pp_images = isSet
              ? jQuery.map(l, function (t, e) {
                  if (-1 != w(t).attr(settings.hook).indexOf(theRel))
                    return w(t).attr("href");
                })
              : w.makeArray(w(this).attr("href"))),
            (pp_titles = isSet
              ? jQuery.map(l, function (t, e) {
                  if (-1 != w(t).attr(settings.hook).indexOf(theRel))
                    return w(t).find("img").attr("alt")
                      ? w(t).find("img").attr("alt")
                      : "";
                })
            ...
            (pp_descriptions = isSet
              ? jQuery.map(l, function (t, e) {
                  if (-1 != w(t).attr(settings.hook).indexOf(theRel))
                    return w(t).attr("title") ? w(t).attr("title") : "";
                })
            ...
            (rel_index = isSet
              ? set_position
              : w("a[" + settings.hook + "^='" + theRel + "']").index(w(this))),
            y(),
            settings.allow_resize &&
              w(window).on("scroll.prettyphoto", function () {
                u();
              }),
            w.prettyPhoto.open(),
            !1
          ...
          return (
            "undefined" == typeof settings &&
              ...
              (pp_titles = arguments[1]
                ? w.makeArray(arguments[1])
                : w.makeArray("")),
              (pp_descriptions = arguments[2]
                ? w.makeArray(arguments[2])
                : w.makeArray("")),
              (isSet = 1 < pp_images.length),
              (set_position = arguments[3] || 0),
              y(t.target)),
            settings.hideflash &&
              w("object,embed,iframe[src*=youtube],iframe[src*=vimeo]").css(
                "visibility",
                "hidden"
              ),
            1 < w(pp_images).length ? w(".pp_nav").show() : w(".pp_nav").hide(),
            ...
            (movie_width = parseFloat(k("width", pp_images[set_position]))
              ? k("width", pp_images[set_position])
              : settings.default_width.toString()),
            (movie_height = parseFloat(k("height", pp_images[set_position]))
              ? k("height", pp_images[set_position])
              : settings.default_height.toString()),
            (r = !1),
            -1 != movie_height.indexOf("%") &&
              ((movie_height = parseFloat(
                (w(window).height() * parseFloat(movie_height)) / 100 - 150
              )),
              (r = !0)),
            -1 != movie_width.indexOf("%") &&
              ((movie_width = parseFloat(
                (w(window).width() * parseFloat(movie_width)) / 100 - 150
              )),
              (r = !0)),
            $pp_pic_holder.fadeIn(function () {
              switch (
                ...
                (imgPreloader = ""),
                (skipInjection = !1),
                f(pp_images[set_position]))
              ) {
                case "image":
                  (imgPreloader = new Image()),
                    (nextImage = new Image()),
                    isSet &&
                      set_position < w(pp_images).length - 1 &&
                ...
                case "youtube":
                  (i = g(movie_width, movie_height)),
                    ...
                    k("rel", pp_images[set_position])
                      ? (movie += "?rel=" + k("rel", pp_images[set_position]))
                      : (movie += "?rel=1"),
                    settings.autoplay && (movie += "&autoplay=1"),
                    (toInject = settings.iframe_markup
                      .replace(/{width}/g, i.width)
                      .replace(/{height}/g, i.height)
                ...
                case "vimeo":
                  ...
                  break;
                case "quicktime":
                  ((i = g(movie_width, movie_height)).height += 15),
                    (i.contentHeight += 15),
                ...
                case "inline":
                  (myClone = w(pp_images[set_position])
                    ...
                    .show()),
                    (doresize = !1),
                    (i = g(w(myClone).width(), w(myClone).height())),
                    (doresize = !0),
                    w(myClone).remove(),
                    (toInject = settings.inline_markup.replace(
                      /{content}/g,
                      w(pp_images[set_position]).html()
                    ));
              }
              imgPreloader ||
                skipInjection ||
        ...
        (w.prettyPhoto.changePage = function (t) {
          (currentGalleryPage = 0),
            "previous" == t
              ? (set_position--,
                set_position < 0 && (set_position = w(pp_images).length - 1))
              : "next" == t
              ? (set_position++,
                set_position > w(pp_images).length - 1 && (set_position = 0))
              : (set_position = t),
        ...
        (w.prettyPhoto.close = function () {
          $pp_overlay.is(":animated") ||
            ...
            $pp_pic_holder
              ...
              .find("object,embed")
              .css("visibility", "hidden"),
            w("div.pp_pic_holder,div.ppt,.pp_fade").fadeOut(
              settings.animation_speed,
              function () {
                w(this).remove();
              }
            ...
            $pp_overlay.fadeOut(settings.animation_speed, function () {
              settings.hideflash &&
                ...
                w(this).remove(),
                w(window).off("scroll.prettyphoto"),
        ...
        !pp_alreadyInitialized &&
          ...
          setTimeout(function () {
            w(
              "a[" + e.hook + "^='" + hashRel + "']:eq(" + hashIndex + ")"
            ).trigger("click");
          }, 50)),
        this.off("click.prettyphoto").on(
          "click.prettyphoto",
          w.prettyPhoto.initialize
        )
      );
    });
})(jQuery);
